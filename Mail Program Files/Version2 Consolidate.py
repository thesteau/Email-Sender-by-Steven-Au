...
class AutoEmailProgram(AutoMailKey):
    pass
    ...
    """
    Needs to include functions regarding sending and procedures related to the class
    Mostly functions regarding solely on emails itself.
...
## Will be its individual file due to transferrability to other projects
class FileProcess(AutoMailKey):
    pass
    ...
    """
    Needs to include any file manipulation procedures to a pannel data format.
    """
